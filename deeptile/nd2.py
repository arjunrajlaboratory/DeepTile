...
def parse(image, metadata, overlap, slices):
...
def stitch(image, metadata, overlap, slices):

    tiles, n_blocks, overlap, image_shape, tile_indices, border_indices = parse(image, metadata, overlap, slices)
